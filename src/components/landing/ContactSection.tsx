      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Have questions about ClauseFinder? Ready to transform your contract review process?
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-600">+1 (888) 555-CLAUSE</p>
                  <p className="text-slate-500 text-sm">Monday-Friday, 9AM-6PM EST</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-600">hello@clausefinder.ai</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg font-medium text-slate-900">Visit Us</h4>
                  <p className="text-slate-600">100 Innovation Drive</p>
            ...
            <div className="mt-10">
              <h4 className="text-lg font-medium text-slate-900 mb-4">Follow Us</h4>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full py-3 px-6 text-white font-medium bg-brand-600 hover:bg-brand-700 rounded-lg shadow transition-colors disabled:opacity-70"
                >
                  {isSubmitting ? (
